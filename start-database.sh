...
DB_CONTAINER_NAME="pam-hotel-admin-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=pam-hotel-admin -d -p 5432:5432 docker.io/postgres
