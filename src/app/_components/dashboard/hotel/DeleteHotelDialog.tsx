        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <DialogFooter className="flex justify-end gap-2">
                    ...
                    <Button type="button" variant={'destructive'} onClick={confirmDelete} disabled={deleteInfo.isLoading}>
                        {
                            deleteInfo.isLoading ? <> <ReloadIcon className="mr-2 h-4 w-4 animate-spin" />Please wait</> : 'Confirm'
                        }
                    </Button>
                </DialogFooter>
